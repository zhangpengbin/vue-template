...
export const constantRouterMap = [{
  ...
  },
  {
    path: '/orderinvoice',
    component: Layout,
    redirct: '/orderinvoice/index',
    children: [{
      path: 'index',
      component: () =>
        import ('@/views/order-invoice/index'),
      name: 'orderinvoice',
      meta: {
        title: "订单开票",
        icon: "documentation",
  ...
  },
  {
    path: '/manual',
    component: Layout,
    redirct: '/manual/index',
    children: [{
      path: 'index',
      component: () =>
        import ('@/views/manual-operation/index'),
      name: 'manual',
      meta: {
        title: "手动开票",
        icon: "documentation",
  ...
  },
  {
    path: '/invoice',
    component: Layout,
    redirct: '/invoice/index',
    children: [{
      path: 'index',
      component: () =>
        import ('@/views/invoice-management/index'),
      name: 'invoice',
      meta: {
        title: "发票管理",
        icon: "documentation",
  ...
  },
  {
    path: '/record',
    component: Layout,
    redirct: '/record/index',
    children: [{
      path: 'index',
      component: () =>
        import ('@/views/invoice-record/index'),
      name: 'record',
      meta: {
        title: "开票记录",
        icon: "documentation",
